...
Poincare ball (``poincare_ball`` / ``RGMIN_MANIFOLD_POINCARE_BALL``):
open unit ball, conformal-metric projection, Mobius exponential
retraction. Distinct from the sphere and from the hyperboloid
model.
