#+TITLE: Why the line search terminates: brackets, cubics, and a guard
...
[[file:../../../proofs/lean/Rgmin/Zoom.lean][proofs/lean/Rgmin/Zoom.lean]].
...
and Wright eq. 3.59)
  ...
  d2 = sign(hi - lo) sqrt(d1^2 - phi'(lo) phi'(hi))
...
* The guard is the termination proof
...
[[file:../../../proofs/lean/Rgmin/Zoom.lean][Zoom.lean]]:
