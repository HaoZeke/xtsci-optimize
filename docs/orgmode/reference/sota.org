...
A 2026 literature survey plus a six-agent Borda vote added four
tokens that share ~xts_solver_t~ and a fused =(f, g)=:
...
were surveyed and rejected for this token set: DFP is dominated by
BFGS already in the crate, the derivative-free methods waste force
calls on an analytic PES, and Steihaug lost the Borda fourth slot
to FIRE 2.0.
